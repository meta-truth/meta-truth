...
def options_and_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Meta-Truth thinks for you about the meanings.",
        epilog="Example:  meta-truth input_text.txt > output_text.txt"
...
def run():
    """
    $ text | meta-truth                        # Accepts text from the pipe
    $ echo "...<text>..." | meta-truth         #

    $ meta-truth multilogue.txt new_turn.txt    # ...or files.
    """
    ...
    try:
        ...
        syslog.syslog(syslog.LOG_INFO, f"meta-truth: {utterance}.")
        syslog.closelog()
